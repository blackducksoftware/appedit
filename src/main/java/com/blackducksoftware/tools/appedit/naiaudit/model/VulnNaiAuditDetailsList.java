...
public class VulnNaiAuditDetailsList {
    ...
    public VulnNaiAuditDetailsList(List<VulnNaiAuditDetails> vulnNaiAuditDetailsList) {
    ...
    public void setVulnNaiAuditDetailsList(List<VulnNaiAuditDetails> vulnNaiAuditDetailsList) {
        this.vulnNaiAuditDetailsList = vulnNaiAuditDetailsList;
    }
