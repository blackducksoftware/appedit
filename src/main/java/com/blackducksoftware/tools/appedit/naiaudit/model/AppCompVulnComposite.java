...
public class AppCompVulnComposite {
    ...
    public AppCompVulnComposite(AppCompVulnKey key, AppCompVulnDetails ccPart, VulnNaiAuditDetails auditPart) {
        this.key = key;
        this.ccPart = ccPart;
    ...
    public String toString() {
        return "AppCompVulnComposite [key=" + key + ", ccPart=" + ccPart + ", auditPart=" + auditPart + "]";
    }
