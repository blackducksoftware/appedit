...
public class JdbcVulnNaiAuditDetailsDao implements VulnNaiAuditDetailsDao {
    ...
    public VulnNaiAuditDetails updateVulnNaiAuditDetails(VulnNaiAuditDetails vulnNaiAuditDetails) {
        ...
        return new VulnNaiAuditDetails(new AppCompVulnKey("test_applicationId", "test_requestId", "test_componentId", "test_vulnerabilityId"),
    ...
    public Map<AppCompVulnKey, VulnNaiAuditDetails> getVulnNaiAuditDetailsMap(String applicationId) {
        ...
        AppCompVulnKey key = new AppCompVulnKey("test_applicationId1", "test_requestId1", "test_componentId1",
        ...
        key = new AppCompVulnKey("test_applicationId2", "test_requestId2", "test_componentId2", "test_vulnerabilityId2");
