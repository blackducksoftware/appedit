...
<div class="page-header">
    <img src="${pageContext.request.contextPath}/styles/icons/Black_Duck_Logo.png" alt="Black Duck Logo"  width="200" height="50" id=""/>       	
        <h1><spring:message code="label.error.404.title" text="Invalid Page Request" /></h1>
    </div>
<p class="advice"><spring:message code="label.error.404.advice" text="This application should be accessed from Code Center." /></p>
